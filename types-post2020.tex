...
the formulation of CR3, since CR3 is used in \Cref{lem:app} to
...
\begin{proof}
  ...
  normalizing, thus we side induct on $E \cdot \vec E \in \SN(\whd[\pi])$.
  \begin{caselist}

    \nextcase $I = \inn\to{00}(t,u')$ with
    $t \perp (\A \to \B)[\A]_\Gamma$ and
    $u' \perp (\A \to \B)[\B]_\Gamma$.  We proceed by a second side induction on
